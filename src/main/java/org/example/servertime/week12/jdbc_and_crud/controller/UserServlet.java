package org.example.servertime.week12.jdbc_and_crud.controller;

import org.example.servertime.week12.jdbc_and_crud.DAO.UserDAO;
import org.example.servertime.week12.jdbc_and_crud.model.User;
...
public class UserServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/week12_tomcat/jdbc_and_crud/view/edit.jsp");
    ...
    private void insertUser(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/week12_tomcat/jdbc_and_crud/view/create.jsp");
        dispatcher.forward(request, response);
    }
